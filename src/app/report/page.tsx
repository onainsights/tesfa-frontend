    ...
    <ProtectedRoute>
      <Layout>
        <div className="bg-surface-secondary overflow-y-auto h-screen">
          {/* Hero Header */}
          <div className="text-[#2BB8A8] px-8 py-10 max-w-2xl mx-auto">
          ...
          <div className="max-w-6xl mx-auto px-8 py-10 space-y-12">
            ...
            {/* AI Disclaimer */}
<div className="flex gap-3 p-4 bg-surface-tertiary rounded-xl border border-border">
  <span className="text-accent-muted flex-shrink-0">⚠</span>
  <p className="text-sm text-primary-dark/70 leading-relaxed">
    This report is produced by artificial intelligence and may contain errors or inaccuracies. Predictions are indicative only and should not replace expert medical or humanitarian judgment. Always verify findings with local data and subject matter experts.{' '}
    <a href="/methodology" className="text-primary hover:underline">Learn how this works →</a>
  </p>
</div>

            {/* Footer */}
            <div className="text-center text-sm text-gray-400 py-8 border-t border-gray-200">
              <p>Generated by Tesfa Health Intelligence Platform </p>
